...
pub use git::{
    ...
    RestoreOnlyUnstagedDiffHunkDelegate, UncommittedDiffHunkDelegate,
    format_stack_review_comment_timestamp, render_diff_hunk_controls, set_blame_renderer,
};
...
pub struct Editor {
    ...
    stack_review_agent_loading_record_ids: HashSet<String>,
...
impl Editor {
    ...
    fn new_internal(
        ...
        let mut editor = Self {
            ...
            stack_review_agent_loading_record_ids: HashSet::default(),
